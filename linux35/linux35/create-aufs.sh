...
rm ../tmp/linux-3.x-rcN/include/linux/Kbuild
cd ../tmp
diff -Naur null linux-3.x-rcN  | filterdiff | \
sed -e 's|null\(/include/linux/Kbuild\)|linux-3.x-rcN-old\1|;s|^--- null.*|--- /dev/null|;\|linux-3.x-rcN/include/linux/Kbuild|,${\|@@ -0,0 +1 @@|,$d}' \
